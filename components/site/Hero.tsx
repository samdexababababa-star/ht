...
export function Hero({
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-5 pt-20 pb-28 md:pt-32 md:pb-40">
        <motion.div
          ...
          className="max-w-3xl"
        >
          <div className="chip chip-blue mb-6">
            <span className="h-1.5 w-1.5 rounded-full bg-primary" />
            New • Built for Africa, ready worldwide
          </div>
          <h1 className="text-5xl md:text-7xl leading-[1.02] tracking-[-0.02em] font-semibold">
